<div class="mx-auto">
    <h3 class="mx-4 text-3xl font-medium text-gray-700">Bienvenidos</h3>
    ...
    <div class=" p-5 text-3xl font-medium text-gray-700">
        <h3>CATEGORIAS</h3>
    </div>
    ...
    <div id="catalogo" class=" p-5 text-3xl font-medium text-gray-700">
        <h3>CATALOGO</h3>
    </div>
    <div>
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
